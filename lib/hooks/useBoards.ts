...
import { deleteColumn as deleteColumnAction } from "../actions/columns";
...
export function useBoard(initialBoard?: Board | null) {
  ...
  async function deleteColumn(columnId: string, boardId: string) {
    setError(null);

    const result = await deleteColumnAction(columnId, boardId);
